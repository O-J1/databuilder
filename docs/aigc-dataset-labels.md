...
| [ComplexDataLab/OpenFake](https://huggingface.co/datasets/ComplexDataLab/OpenFake) | real and fake | `model` column | Card/schema provides `real`/`fake` labels and the source model. |
...
| [liu123-2/FakeClue](https://huggingface.co/datasets/liu123-2/FakeClue) | fake only | `fakeclue` | Train/test archives contain the generated benchmark images. |
| [stdKonjac/DIM-T2I](https://huggingface.co/datasets/stdKonjac/DIM-T2I) | none (raw snapshot) | unknown | Metadata/path repository without a self-contained, uniformly labelled image payload. |
